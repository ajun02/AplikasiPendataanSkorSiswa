        ...
        <div class="container">
            <div class="card mt-2">
                <!-- <div class="card-header text-center">
                    Data Kategori - <strong>EDIT DATA</strong>
                </div> -->
                <div class="card-body">
                    <form method="post" action="/kategori/update/{{ $kategori->id_kategori }}">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <input type="text" name="id_kategori" class="form-control" value=" {{ $kategori->id_kategori }}">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" name="nm_kategori" class="form-control" value=" {{ $kategori->nm_kategori }}">
